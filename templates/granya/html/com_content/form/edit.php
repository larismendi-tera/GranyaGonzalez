...
<div class="edit item-page<?php echo $this->pageclass_sfx; ?> static-article-layout shadowed-center">
<h2 class="article-title shadowed-right"> 
	<a href="#"><?php echo $this->escape($params->get('page_title')); ?></a>
</h2>
...
<form action="<?php echo JRoute::_('index.php?option=com_content&a_id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	<fieldset>
			...
			<?php echo JText::_('COM_CONTENT_ARTICLE_TEXT'); ?>
			<div class="formelm">
