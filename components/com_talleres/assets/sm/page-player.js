...
function PagePlayer() {
  ...
  this.handleClick = function(e) {
    ...
    //o.href = o.getAttribute('data-href');

    this.canPlayLink = function(o) {
          if (o.href.endsWith('?view=media')) {
              return true;
          }
          return sm.canPlayLink(o);
    }


      //if (!o.href || (!sm.canPlayLink(o) && !self.hasClass(o,'playable')) || self.hasClass(o,'exclude')) {
    if (!o.href || (!this.canPlayLink(o) && !self.hasClass(o,'playable')) || self.hasClass(o,'exclude')) {
      ...
      soundURL = o.href;
//      var n = soundURL.search("/component/talleres/a.mp3");

      if (soundURL.endsWith("?view=media")) {
          soundURL += "&format=raw";
      }

      //soundURL = o.getAttribute('data-href');
