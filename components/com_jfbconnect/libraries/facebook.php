...
class JFBConnectFacebookLibrary extends JObject
{
    ...
    function initDocument()
    {
        ...
        $doc->addScript(JURI::base(true) . '/components/com_jfbconnect/includes/jfbconnect.js?v=421');
    ...
    function getLoginButton($buttonSize = "medium")
    {
        ...
        return '<fb:login-button v="2" size="' . $buttonSize . '" ' . $perms . ' onlogin="javascript:jfbc.login.on_login();">' . JText::_('COM_JFBCONNECT_LOGIN_USING_FACEBOOK') . '</fb:login-button>';
    }
