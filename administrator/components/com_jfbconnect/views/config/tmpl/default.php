...
<div>
    ...
    <div class="config_row">
        ...
        <div class="config_description hasTip"
            ...
            Facebook.<br/><br/>
            <b>Automatic Registration</b><br/>A pseudo-Joomla user is created when a user logs in using Facebook. They will not
...
<div>
    ...
    <div class="config_row">
        <div class="config_setting">Integrate into Joomla Registration:</div>
        <div class="config_option">
        ...
        <div class="config_description hasTip"
             title="Include Login with Facebook button on Joomla registration">Info
        </div>
        <div style="clear:both"></div>
    </div>
    <div class="config_row">
