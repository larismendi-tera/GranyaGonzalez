...
class JUserportHtml
{
  ...
  function ShowOptions( $task, $title, $settings, $hidden = array() )
  {
    ...
    <form action="index.php" method="post" name="adminForm">
      <fieldset class="adminform">
        ...
        $activationUrl = $base . '/index.php?option=com_users&task=registration.activate&token=';
        $groups = JUserportHelper::UserGroups();
  ...
  function PrintHelp()
  {
    ...
    $jedUrl = 'http://extensions.joomla.org/extensions/migration-a-conversion/users-import-a-export/5430';
    ...
    echo JText::sprintf( 'COM_USERPORT_HELP_TASK_OVERVIEW_ADD', JText::_( 'COM_USERPORT_BUTTON_CHOOSE_INITIAL_TEXT' ), JText::_( 'COM_USERPORT_BUTTON_SHOW_EDIT_WINDOW' ), JText::_( 'COM_USERPORT_BUTTON_ADD' ), JText::_( 'COM_USERPORT_BUTTON_ADD' ) );
    echo JText::sprintf( 'COM_USERPORT_HELP_TASK_OVERVIEW_UPDATE', JText::_( 'COM_USERPORT_BUTTON_CHOOSE_INITIAL_TEXT' ), JText::_( 'COM_USERPORT_BUTTON_SHOW_EDIT_WINDOW' ), JText::_( 'COM_USERPORT_BUTTON_UPDATE' ), JText::_( 'COM_USERPORT_BUTTON_UPDATE' ) );
    echo JText::sprintf( 'COM_USERPORT_HELP_TASK_OVERVIEW_DELETE', JText::_( 'COM_USERPORT_BUTTON_CHOOSE_INITIAL_TEXT' ), JText::_( 'COM_USERPORT_BUTTON_DELETE' ) );
    echo JText::_( 'COM_USERPORT_HELP_TASK_OVERVIEW_END' );
    echo JText::sprintf( 'COM_USERPORT_HELP_CLOSURE', $bugUrl, $featureUrl, $jedUrl, $donateUrl );
  }
