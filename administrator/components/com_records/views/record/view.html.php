 ...
 */
class RecordsViewRecord extends JView
{
    protected $form;
    protected $item;
    protected $state;
    ...
    protected function addToolbar()
    {
        ...
        JToolBarHelper::title(JText::_('COM_RECORDS_MANAGER_RECORDS_ANSWER'), 'contact.png');
        ...
        //if (!$checkedOut && ($canDo->get('core.edit') || (count($user->getAuthorisedCategories('com_talleres', 'core.create'))))) {
            ...
            JToolBarHelper::save('record.save', 'COM_RECORDS_SENT_ANSWER');
        //}
