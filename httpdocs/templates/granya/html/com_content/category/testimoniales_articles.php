...
<!--            </th>-->
        ...
        <tbody>
            ...
            <?php $completeUrl = JURI::root() . $relativeUrl; ?>
        <tr class="<?php if ($i % 2 == '0') { echo 'odd'; } else { echo 'even'; } ?>">
            ...
            <td class="article_info">
                ...
                <div class="article_list_title">
                    <div class="addthis_toolbox addthis_default_style" addthis:url="<?php echo  $completeUrl ?>" addthis:title="<?php echo $this->escape($article->title); ?>" addthis:description="<?php echo $this->escape($article->title); ?>">
                    ...
                    <a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($article->slug, $article->catid)) . "&Itemid=" . $_GET["Itemid"]; ?>"><?php echo $this->escape($article->title); ?></a></div>
