...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
	...
	<fieldset class="word">
		...
		<button name="Search" onclick="this.form.submit()" class="button"><?php echo JText::_('COM_SEARCH_BUTTON');?></button>
...
<?php if ($this->total > 0) : ?>
	...
	<div class="form-limit">
		<input type="hidden" class="inputbox" name="limit" id="limit" value="10"/>
