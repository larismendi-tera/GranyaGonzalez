...
//   echo "<br />Task: " . $task . "<br />";
   ...
   * First trim any ASCII control characters as well.
   */
  $settings[ 'user_list' ] = ltrim( $settings[ 'user_list' ], "\x00..\x1F");
  $settings[ 'user_list' ] = ltrim( $settings[ 'user_list' ], "\xEF\xBB\xBF");
  $settings[ 'user_list' ] = trim( $settings[ 'user_list' ] );
