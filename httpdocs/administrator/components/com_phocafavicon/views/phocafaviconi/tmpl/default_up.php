		...
		<div class="phocafavicon-box-file-first-i">
			<div class="phocafavicon-box-file-second">
				<div class="phocafavicon-box-file-third">
					<center>
					<a href="index.php?option=com_phocafavicon&amp;view=phocafaviconi&amp;tmpl=component&amp;folder=<?php echo $this->folderstate->parent .'&amp;field='. $this->field; ?>" ><?php echo JHTML::_( 'image', 'administrator/components/com_phocafavicon/assets/images/icon-64-up.png', ''); ?></a>
					</center>
				</div>
			</div>
		</div>
