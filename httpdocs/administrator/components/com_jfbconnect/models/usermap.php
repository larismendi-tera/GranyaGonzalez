...
class JFBConnectModelUserMap extends JModel
{
    ...
    {
        $query = "UPDATE #__jfbconnect_user_map SET authorized=1, access_token = " . $this->_db->quote($token) .
    ...
    {
        $query = "UPDATE #__jfbconnect_user_map SET authorized = " . $this->_db->quote($authorize) .
